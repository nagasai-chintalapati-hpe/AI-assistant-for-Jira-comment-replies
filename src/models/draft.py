...
class Draft(BaseModel):
    ...
    # Audit
    jira_custom_field_id: Optional[str] = None  # For Jira UI storage
    teams_card_id: Optional[str] = None  # For Teams approval
    ...
    class Config:
        json_schema_extra = {
            "example": {
                ...
                "citations": [
                    {
                        "source": "Confluence: Upload Handler",
                        "excerpt": "Max file size: 100MB",
                    }
                ],
                "status": "generated",
            }
